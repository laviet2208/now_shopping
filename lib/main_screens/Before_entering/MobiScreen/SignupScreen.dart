                  ...
                  child: Container(
                      ...
                      child: ListView(
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.only(left: 10, right: 10),
                            child: ButtonType1(Height: 60 , Width: screenWidth * 0.418, color: Color.fromARGB(255, 54, 105, 201), radiusBorder: 10, title: "Sign up", fontText: 'Dmsan_regular', colorText: Colors.white,
                              onTap: (){
